...
Public Class ReportFinal
    ...
    Private Sub ReportFinal_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        dBConnect()
        fillAY()
    End Sub
    Public Sub fillAY()
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        Using conn As New MySqlConnection(String.Format("server={0}; user id={1}; password={2}; database={3}; pooling=false", server, userName, password, DatabaseName))
            conn.Open()
            Dim command As New MySqlCommand("select Snum,Lname,Fname,PGrade,MGrade,FGrade,SFinal,FNum,Remarks from tblgsheet where SYear='" & cboAY.Text & "' and SCode='" & cboSubCode.Text & "' and Course='" & cboCourse.Text & "' and Section ='" & cboSec.Text & "'", conn)
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        dB.ConnectionString = String.Format("server={0}; user id={1}; password={2}; database={3}; pooling=false", server, userName, password, DatabaseName)
        dB.Open()
        Dim squery As String = "select Snum,Lname,Fname,PGrade,MGrade,FGrade,SFinal,FNum,Remarks from tblgsheet where SYear='" & cboAY.Text & "' and SCode='" & cboSubCode.Text & "' and Course='" & cboCourse.Text & "' and Section ='" & cboSec.Text & "'"
        Dim sadapter As New MySqlDataAdapter
        Dim scommand As New MySqlCommand
        ...
        xlWorkSheet.Cells(1, 1) = "GRADE SHEET SUMMARY REPORT FOR AY " + cboAY.Text ' Class
        ...
        xlWorkSheet.Cells(8, 4) = "Prelim"
        xlWorkSheet.Cells(8, 5) = "Midterm"
        xlWorkSheet.Cells(8, 6) = "Final"
        xlWorkSheet.Cells(8, 7) = "GrandTotal"
        xlWorkSheet.Cells(8, 8) = "SemestialGrade"
        xlWorkSheet.Cells(8, 9) = "Remarks"
